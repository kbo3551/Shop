...
<div class="container-fluid">
	...
	<!-- 후기 네비게이션 바 -->
		<div style="margin: auto; text-align: center;">
			<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&commentCurrentPage==1&qnaCurrentPage=<%=qnaCurrentPage%>">처음으로</a>
		<%
			if(commentCurrentPage != 1){
		%>
				<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&commentCurrentPage=<%=commentCurrentPage-1%>&qnaCurrentPage=<%=qnaCurrentPage%>">이전</a>
		<%
			}
		...
		%>
					<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&commentCurrentPage=<%=i%>&qnaCurrentPage=<%=qnaCurrentPage%>"><%=i%> </a>
		<%
		...
		<%
			...
			%>
				<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&commentCurrentPage=<%=commentCurrentPage+1%>&qnaCurrentPage=<%=qnaCurrentPage%>">다음</a>
			<%
			}
			%>
			<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&commentCurrentPage=<%=CommentLastPage%>&qnaCurrentPage=<%=qnaCurrentPage%>">끝으로</a>
		</div>
	<%
	}
	%>
	...
	<!-- 문의 네비게이션 바 -->
		<div style="margin: auto; text-align: center;">
			<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&qnaCurrentPage=1&commentCurrentPage=<%=commentCurrentPage%>">처음으로</a>
		<%
			if(qnaCurrentPage != 1){
		%>
				<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&qnaCurrentPage=<%=qnaCurrentPage-1%>&commentCurrentPage=<%=commentCurrentPage%>">이전</a>
		<%
			}
		...
		%>
					<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&qnaCurrentPage=<%=i%>&commentCurrentPage=<%=commentCurrentPage%>"><%=i%> </a>
		<%
		...
		<%
			...
			%>
				<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&qnaCurrentPage=<%=qnaCurrentPage+1%>&commentCurrentPage=<%=commentCurrentPage%>">다음</a>
			<%
			}
			%>
			<a class="btn btn-info" href="<%=request.getContextPath()%>/selectEbookOne.jsp?ebookNo=<%=ebookNo %>&qnaCurrentPage=<%=QnaLastPage%>&commentCurrentPage=<%=commentCurrentPage%>">끝으로</a>
		</div>
	<%
	}
	%>
